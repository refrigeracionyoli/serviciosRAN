-- Allows the workshop lifecycle trigger to repair a missing movement when an
-- already completed service is closed, without duplicating movements that
-- were already generated on completion.
